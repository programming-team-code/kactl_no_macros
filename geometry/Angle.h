 ...
 * by int points and a number of rotations around the
 * origin). Useful for rotational sweeping. Sometimes also
 * represents points or vectors. Usage: vector<Angle> v =
 * {w[0], w[0].t360() ...}; // sorted int j = 0; rep(i,0,n)
...
// between them, i.e., the angle that covers the defined
// line segment.
