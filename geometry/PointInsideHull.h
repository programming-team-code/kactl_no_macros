 ...
 * convex hull (CCW order, with no collinear points).
 * Returns true if point lies within the hull. If strict is
 * true, points on the boundary aren't included. Usage:
